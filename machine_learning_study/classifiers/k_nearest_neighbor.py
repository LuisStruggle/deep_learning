...
class KNearestNeighbor:
    ...
    def predict(self, X, k=1, num_loops=0):
        ...
        Output:
        y - A vector of length num_test, where y[i] is the predicted label
    ...
    def predict_labels(self, dists, k=1):
        ...
        Input:
        dists - A num_test x num_train array where dists[i, j] gives the
        distance between the ith test point and the jth training point.

        Output:
        y - A vector of length num_test where y[i] is the predicted label for
        the ith test point.
        """
